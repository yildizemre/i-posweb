...
import OwnerWalletPage from './panel/OwnerWalletPage'
import RequireFleet from '../components/RequireFleet'
  ...
  return (
    <Routes>
      <Route element={<DashboardLayout />}>
        ...
        <Route path="cuzdanim" element={<RequireFleet><OwnerWalletPage /></RequireFleet>} />
