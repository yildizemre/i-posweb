            ...
            <tbody>
              {report.plates.map((p) => (
                <tr key={p.plate}>
                  ...
                  <td><span className={es.badge}>{p.owner}</span></td>
                  <td>{p.driver}</td>
                  <td>{p.city}</td>
              ...
              <tr className={es.footerTotal}>
                <td colSpan={6}>Toplam Plaka Kazancı</td>
                <td className={es.teal}>{formatMoney(report.platformTotal)}</td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              {report.drivers.map((d) => (
                <tr key={`${d.plate}-${d.driver}`}>
                  ...
                  <td><span className={es.badge}>{d.owner}</span></td>
                  <td>{d.plate}</td>
                  <td>{d.city}</td>
              ...
              <tr className={es.footerTotal}>
                <td colSpan={7}>Toplam Sürücü Kazancı</td>
